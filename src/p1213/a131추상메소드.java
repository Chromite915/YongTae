...
public abstract class a131추상메소드 {
	public abstract int add(int a, int b); // 덧셈으로 할 예정
	public abstract int substract(int a, int b); // 뺄셈 예정
	public abstract double average(int [] a); // 배열의 평균 예정



// public class MiniCalc extends a13추상 {
	/* 폰카
	 * 추상클래스(abstract) :
