...
public class a01메모 {
	 ...
	 * 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 - 깃허브 토큰
	 * 문의댓글 확인하기
	 * 
	 * 
	 * 
	 * 
	 * [내 아이디어]
	 * 일단 퀄리티는 작게 시작해서(작더라도 결과를 내는데에 집중), 그 후에 퀄리티를 높이기
	 * 스윙을 데이터베이스와 연결, 검색결과가 이클립스 스윙창에 뜨도록
	 * 라벨+체크박스 - 데이터베이스 연결 - 간단테스트 - 대분류 - 기타 꾸미기
	 * 검색버튼 누르면 결과 보여주기
	 * 클릭하면 사진 띄우기
	 * 동시 2개까지 비교 가능
	 * 
	 ...
	 * (비정상), (department는 나오는데, supervisior는 안나옴)
	 * 
