...
class RandomThread extends Thread {
	...
	public void finish(Point p) {			// 클릭시 이 메소드 호출
		flag = true;
		this.p = p;
	}
...
public class a15랜덤위치 extends JFrame {
	...
	public a15랜덤위치() {
		...
		c.addMouseListener(new MouseAdapter() {
			public void mousePressed(MouseEvent e) {
				th.finish(e.getPoint());			// 클릭시 finish메소드 호출
			}
		});
		setSize(300,200);
		setVisible(true);
