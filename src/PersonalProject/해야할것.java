...
public class 해야할것 {
	 ...
	 * 
	 * [주의사항]
	 * MyP, AdviceSwingEx1 2개의 클래스가 같은 다이얼로그 클래스 AdviceDialogEX1을 참조하는 상태
	 * 
	 * 
	 * 
	 * [할 일]
	 * Stock Count는 하나의 테이블로만 관리해야
	 * 인터페이스 완성 - 내용물 수정
	 * 테이블에 내용물 insert - 검색 아이템들의 참조 테이블 수정 - 검색결과 제대로 출력되는지 확인
	 * 판매버튼, 재고버튼 화면 구성하기 - 기능 구현하기
	 * Detail버튼 화면 구성하기 - 기능 구현하기
	 * 이후 추가적인 개발
	 * 1. 일련번호 중복 불가
